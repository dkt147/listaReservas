...
<div class="row">
<h3 class="btn btn-default" style="width:100%;border:2px solid grey;padding-top:12px;height:70px;border-left-width:5px;border-left-color:grey;background:white;text-align:left"><i class='fas fa-user-alt' style='font-size:24px;border:1px solid grey;padding:10px;border-radius:10px'><sup>300</sup></i><input type="submit" class="btn btn-default" style="margin-bottom:7px;margin-left:240px"></h3>
       <br><hr>
</div>       
</div>
...
<div class="row">
  <div class="col">
    ...
    <div class="form-outline">
    <br>
      <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" multiple="multiple" />Male<br>
    </div>
  </div>
  <div class="col">
    <!-- Name input -->
...
<div class="row" style="text-align:center;
  ...
  <div class="col-md-4">    <input style="width: 170px;" type="submit" class="btn btn-default" value="Invitar">
</div>
  <div class="col-md-4"></div>
</div>
